...
const SimulatorPage = () => {
  ...
  const LENS_MIRROR_TOUR: TourStep[] = useMemo(() => [
    ...
    { selector: ".controls-toggle-btn", title: t("নিয়ন্ত্রণ টুলকিট", "Controls Toolkit"), desc: t("এই বাটনে ক্লিক করলে দূরত্ব স্লাইডার, প্রিসেট ও অন্য নিয়ন্ত্রণগুলো একটি প্যানেলে খুলবে।", "Click this button to open a panel with the distance sliders, presets and other controls."), waitForClick: true, isSatisfied: () => !!document.querySelector(".controls-toolkit-panel") },
  ...
  const REFRACTION_TOUR: TourStep[] = useMemo(() => [
    ...
    { selector: ".controls-toggle-btn", title: t("নিয়ন্ত্রণ টুলকিট", "Controls Toolkit"), desc: t("এই বাটনে ক্লিক করলে আপতন কোণ (i), প্রতিসরণ সূচক (n) ও অন্য নিয়ন্ত্রণগুলো একটি প্যানেলে খুলবে।", "Click this button to open a panel with the angle of incidence (i), refractive index (n) and other controls."), waitForClick: true, isSatisfied: () => !!document.querySelector(".controls-toolkit-panel") },
  ...
  const LENS_MIRROR_SIM_GUIDE: TourStep[] = useMemo(() => [
    ...
    { selector: ".controls-toggle-btn", title: t("নিয়ন্ত্রণ খুলো", "Open the Controls"), desc: t("এই বাটনে ক্লিক করে নিয়ন্ত্রণ প্যানেল খুলো — এখানেই দূরত্ব স্লাইডার ও প্রিসেট পাবে।", "Click this button to open the controls panel — that's where you'll find the distance sliders and presets."), waitForClick: true, isSatisfied: () => !!document.querySelector(".controls-toolkit-panel") },
    { selector: ".presets", title: t("বস্তু বসাও", "Place the Object"), desc: t("এই প্রিসেটগুলোর একটিতে ক্লিক করে বস্তুটিকে F বা 2F বিন্দুতে নিয়ে যাও, এবং প্রতিবিম্ব কেমন হয় লক্ষ্য করো।", "Click one of these presets to move the object to F or 2F, and see what kind of image forms."), waitForClick: true, optional: true },
  ...
  const REFRACTION_SIM_GUIDE: TourStep[] = useMemo(() => [
    ...
    { selector: ".controls-toggle-btn", title: t("নিয়ন্ত্রণ খুলো", "Open the Controls"), desc: t("এই বাটনে ক্লিক করে নিয়ন্ত্রণ প্যানেল খুলো — এখানেই কোণ ও প্রতিসরাঙ্কের স্লাইডার পাবে।", "Click this button to open the controls panel — that's where you'll find the angle and refractive-index sliders."), waitForClick: true, isSatisfied: () => !!document.querySelector(".controls-toolkit-panel") },
